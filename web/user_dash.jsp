<%-- 
    Document   : user_dash
    Created on : 13 Jan, 2022, 9:42:09 AM
    Author     : Admin
--%>
...
//            out.print("Hello: " + name);
        ...
        <div class="container-fluid" style="margin-top:2%;">
            <nav class="navbar navbar-expand-lg navbar-light" style="background-color:#000071;">
                <div class="px-1">
                    <a class="navbar-brand" href="#" style="color:white">Hello,&nbsp<span style="color:#FFD800"><%out.print(session.getAttribute("name"));%></span></a>
                </div>
                <div class="">
