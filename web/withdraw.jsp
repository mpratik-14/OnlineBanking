<%-- 
    Document   : withdraw
    Created on : 13 Jan, 2022, 1:17:55 PM
    Author     : Admin
--%>
...
//            out.print("Hello: " + name);
        ...
        <div class="">
            <div class="container bg-dark mt-5">
                <h5 class="text-white text-center">Withdraw Amount in Bank Account</h5>        
            </div>
        </div>  
                ...
                <div class="row pt-3" style='border:2px solid black; margin:auto;width:90%;margin-top:5%;padding:20px;background-color:#ABFFF5'>
                        ...
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-6 col-8">
                            <form action="withdraw_data.jsp" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <h5 class="text-center">Your Account Number</h5>
...
//                                        int nm4=Integer.parseInt(nm3);
                                ...
                                <div class="mb-3">
                                    <h5 class="text-center">How much Amount want to withdraw</h5>
                                    <input type="text" name="money" class="form-control" placeholder="1000 Rs.">
                                </div>
                                <div class="mb-3">
                                    <h5 class="text-center">Enter your 4 digit-Pin</h5>
                                    <input type="password" name="otp" class="form-control" placeholder="XXXX">
                                </div>
                                <div class="text-center">
                                    <button type="submit" name="button" class="btn btn-primary">Withdraw</button>
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-4 col-md-4 col-xl-4 col-sm-3 col-2"></div>
